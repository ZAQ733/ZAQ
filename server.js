...
// =========================
// UPDATE USER (ADMIN, loan-г хадгална)
// =========================
app.post('/updateUser', (req, res) => {
  ...
  users[email] = {
    ...users[email], // loan, бусад мэдээллийг хадгалах
    name,
    pass,
...
app.post('/repay-loan', (req, res) => {
  ...
  if (user.wallet < user.loan.amount)
    return res.status(400).send("Wallet хүрэлцэхгүй, зээлийг төлж чадахгүй");
